    ...
    return (
      ...
      >
        ...
        <div className="relative text-center w-full px-1">
          ...
          <span
            className={cn(
              "inline-block mt-1 px-1.5 py-[1px] rounded-full text-[8px] font-black uppercase tracking-[0.18em] border",
              style.labelChip,
              style.label
            )}
          >
        ...
        {description && !compact && (
          <p className="text-[10px] text-muted-foreground text-center leading-relaxed line-clamp-2">
            {description}
          </p>
        )}
