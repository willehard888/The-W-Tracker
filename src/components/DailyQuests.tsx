    ...
    <div className="rounded-xl border border-gold/20 bg-gold/5 p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-gold/10 border border-gold/20">
          ...
          <span className="text-label font-bold text-gold">{completedCount}/3</span>
        </div>
      </div>
        ...
        {questStatuses.map((quest) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-label text-muted-foreground">{quest.description}</p>
            </div>
            {quest.completed ? (
              <div className="flex items-center gap-1">
                <span className="text-label font-bold text-gold">+{quest.xpReward}</span>
                <CheckCircle2 aria-hidden size={14} className="text-gold" />
              </div>
            ) : (
              <div className="flex items-center gap-1">
                <span className="text-label font-bold text-muted-foreground">+{quest.xpReward}</span>
