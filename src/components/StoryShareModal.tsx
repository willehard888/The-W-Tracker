          ...
          <div className="flex flex-col items-center justify-center h-full px-6 text-center">
            ...
            {variant === "whealth" && whealthData && (
              <>
                ...
                <p className="font-black tracking-widest text-gold/60 mb-5 text-meta">WHEALTH INDEX / 100</p>
            ...
            {variant === "badge" && badgeData && (
              <>
                ...
                {badgeData.rarity === 'legendary' && (
                  <p className="text-gold/40 font-semibold mt-2 text-label">ONLY TOP 1% EARN THIS</p>
                )}
              </>
            )}
            ...
            {variant === "referral" && (() => {
              ...
              return (
                <>
                  ...
                  <p className="text-muted-foreground/50 text-meta">AI coach · daily check-ins · the full system</p>
                </>
              );
            })()}

            {variant === "referral" ? (
              <p className="absolute bottom-4 text-gold/40 font-bold tracking-[0.22em] text-label">
