...
const YourBlueprintCard = ({ className }: YourBlueprintCardProps) => {
  ...
  return (
    ...
    >
      ...
      {why && (
        <div className="mt-4">
          <p className="text-[9px] font-black uppercase tracking-[0.22em] text-gold/70 mb-1">
            Who I'm becoming
          </p>
      ...
      {hobbies.length > 0 && (
        <div className="mt-3 flex items-center gap-2 flex-wrap">
          <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-[0.22em] text-muted-foreground/70">
...
const Row = ({
  ...
  <div className="rounded-2xl border border-border/40 bg-card/60 px-3 py-2 min-w-0">
    <div className="flex items-center gap-1 text-muted-foreground/70 mb-0.5">
      ...
      <p className="text-[9px] font-black uppercase tracking-[0.22em]">{label}</p>
    </div>
