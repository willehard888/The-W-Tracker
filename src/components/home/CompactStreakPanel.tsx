          ...
          {(() => {
            ...
            const layers = [
              ...
              // 8 — NEW Tiny crimson sputter (left low): small detached tongue.
              {
                ...
                accent: "hsl(8 96% 50%)",
                tier: cappedTier,
                offsetX: -Math.round(master * 0.42),
              ...
              // 9 — NEW Tiny crimson sputter (right low): mirror.
              {
                size: Math.round(master * 0.36),
                accent: "hsl(12 96% 51%)",
                tier: cappedTier,
                offsetX: Math.round(master * 0.43),
                offsetY: Math.round(master * 0.09),
                z: 2,
                opacity: 0.62,
                rotate: 33,
              ...
              // 10 — NEW Mid-tier orange tongue (slightly off-center left): adds
              //      asymmetry and fills the gap between mid-back and core.
              {
                size: Math.round(master * 0.66),
                accent: "hsl(20 98% 54%)",
                tier: cappedTier,
                offsetX: -Math.round(master * 0.12),
              ...
              // 11 — NEW Tall narrow detached tongue: rises high above the crown.
              {
                size: Math.round(master * 0.3),
                accent: "hsl(40 100% 64%)",
                tier: cappedTier,
                offsetX: Math.round(master * 0.04),
                offsetY: -Math.round(master * 0.32),
                z: 6,
                opacity: 0.72,
                rotate: 4,
                shadowMul: 0,
