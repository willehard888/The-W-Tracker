    ...
    <div className="surface-card surface-card-quiet p-4">
      ...
      {hasSleep && last!.sleep_total_min != null && (
        <>
          ...
          <div className="flex items-center gap-3 text-label text-muted-foreground mb-2.5">
        ...
        {last!.resting_hr != null && (
          <div className="flex items-center gap-1.5">
            ...
            {rhrDelta != null && Math.abs(rhrDelta) >= 1 && (
              <span className={cn("text-label font-black tabular-nums", rhrDelta > 0 ? "text-[hsl(var(--ember))]" : "text-xp-green")}>
        ...
        <div className="mb-3 surface-inset rounded-xl px-3 py-2">
          <div className="flex items-center justify-between mb-1">
            ...
            {trendDelta != null && Math.abs(trendDelta) >= 1 && (
              <span className={cn("text-label font-black tabular-nums", trendDelta < 0 ? "text-xp-green" : "text-[hsl(var(--ember))]")}>
