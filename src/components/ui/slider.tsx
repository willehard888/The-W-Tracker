  ...
  >
    <SliderPrimitive.Track className="surface-inset relative h-2 w-full grow overflow-hidden rounded-full">
      <SliderPrimitive.Range
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(42 88% 62%) 0%, hsl(var(--gold)) 55%, hsl(42 64% 42%) 100%)",
          boxShadow:
    ...
    <SliderPrimitive.Thumb
      className={cn(
        ...
        "[background:radial-gradient(circle_at_30%_28%,hsl(42_95%_82%)_0%,hsl(var(--gold))_55%,hsl(42_60%_36%)_100%)]",
