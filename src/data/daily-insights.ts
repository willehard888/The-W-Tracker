...
export const DAILY_INSIGHTS: DailyInsight[] = [
  ...
  { id: "wis-stack-1", text: "Nine teachers, one week, under twenty minutes a day. Believe none of it. Run all of it.", lessonSlug: "wisdom-practice-stack", source: "The Vault" },
  { id: "wis-stack-2", text: "A course is finished when it changes a week, not when the last lesson is marked complete.", lessonSlug: "wisdom-practice-stack", source: "The Vault" },
