...
export interface DailyInsight {
  ...
  text: string;
  lessonSlug: string;
  /** The teacher or book behind the line — named on the card. Wisdom only. */
  source?: string;
}
...
export const DAILY_INSIGHTS: DailyInsight[] = [
  ...
  // ── Wisdom · the great books and teachers (20260916090001). Four voices per
  //    lesson, the teacher named on the card; our own words, never a quoted line.
  { id: "wis-read-1", text: "Read a teacher for the practice you can run on Tuesday. The worldview can wait.", lessonSlug: "how-to-read-a-teacher", source: "The Vault" },
  { id: "wis-read-2", text: "Speculative is not an insult. It means keep the exercise, drop the explanation.", lessonSlug: "how-to-read-a-teacher", source: "The Vault" },
  { id: "wis-read-3", text: "Three sentences per book: the one idea, the practice, the claim you are not buying.", lessonSlug: "how-to-read-a-teacher", source: "The Vault" },
  { id: "wis-read-4", text: "You do not have to believe a teacher to try them on a real Tuesday.", lessonSlug: "how-to-read-a-teacher", source: "The Vault" },
  { id: "wis-atomic-1", text: "You don't need a unanimous election. Every small action is a vote for who you are. Win the majority.", lessonSlug: "atomic-habits-identity", source: "James Clear" },
  { id: "wis-atomic-2", text: "Design the room and you stop needing the willpower. Then never miss twice.", lessonSlug: "atomic-habits-identity", source: "James Clear" },
  { id: "wis-atomic-3", text: "Shrink the habit until it takes two minutes. That is the entrance, not the goal.", lessonSlug: "atomic-habits-identity", source: "James Clear" },
  { id: "wis-atomic-4", text: "One miss is an accident. Two is the start of a new habit.", lessonSlug: "atomic-habits-identity", source: "James Clear" },
  { id: "wis-now-1", text: "The moment you watch a thought, you are no longer inside it. That half-step is the whole practice.", lessonSlug: "power-of-now-presence", source: "Eckhart Tolle" },
  { id: "wis-now-2", text: "The situation right now is usually fine. The story about tomorrow is what hurts.", lessonSlug: "power-of-now-presence", source: "Eckhart Tolle" },
  { id: "wis-now-3", text: "Regret is the past. Anxiety is the future. Action only ever happens now.", lessonSlug: "power-of-now-presence", source: "Eckhart Tolle" },
  { id: "wis-now-4", text: "Sixty seconds: your hands from the inside, the furthest sound, one long exhale. Back.", lessonSlug: "power-of-now-presence", source: "Eckhart Tolle" },
  { id: "wis-ego-1", text: "Ego is the mind saying “I am” to things that can be lost. Catch it once a day, in the act.", lessonSlug: "new-earth-ego", source: "Eckhart Tolle" },
  { id: "wis-ego-2", text: "Do you want to be right, or do you want it fixed? The ego only ever picks one.", lessonSlug: "new-earth-ego", source: "Eckhart Tolle" },
  { id: "wis-ego-3", text: "A grievance is a very stable identity. That is why it can last decades.", lessonSlug: "new-earth-ego", source: "Eckhart Tolle" },
  { id: "wis-ego-4", text: "A role is fine as a function and a trap as an identity. Notice when you start performing it.", lessonSlug: "new-earth-ego", source: "Eckhart Tolle" },
  { id: "wis-aware-1", text: "A feeling that is allowed passes in minutes. A feeling that is fought can last for days.", lessonSlug: "greatest-secret-awareness", source: "Rhonda Byrne" },
  { id: "wis-aware-2", text: "Am I aware? The answer arrived before any thought did. Two seconds, back in the room.", lessonSlug: "greatest-secret-awareness", source: "Rhonda Byrne" },
  { id: "wis-aware-3", text: "Push a feeling down and it comes back stronger. Let it be here and it moves on.", lessonSlug: "greatest-secret-awareness", source: "Rhonda Byrne" },
  { id: "wis-aware-4", text: "Drop the story, find the feeling in the body, and tell it: you can be here.", lessonSlug: "greatest-secret-awareness", source: "Rhonda Byrne" },
  { id: "wis-wealth-1", text: "Money at five, family at one. That is not wealth, whatever the number says.", lessonSlug: "eight-forms-of-wealth", source: "Robin Sharma" },
  { id: "wis-wealth-2", text: "Score eight forms, not one. Then work on the lowest, because the lowest sets how rich life feels.", lessonSlug: "eight-forms-of-wealth", source: "Robin Sharma" },
  { id: "wis-wealth-3", text: "Wellness underwrites everything. Family will be at the hospital bed. Score those first.", lessonSlug: "eight-forms-of-wealth", source: "Robin Sharma" },
  { id: "wis-wealth-4", text: "Adventure for one person is a mountain. For another, a new recipe. Score what feels rich to you.", lessonSlug: "eight-forms-of-wealth", source: "Robin Sharma" },
  { id: "wis-jung-1", text: "Whoever irritates you out of proportion is showing you a page from your own shadow.", lessonSlug: "jung-shadow-individuation", source: "Carl Jung" },
  { id: "wis-jung-2", text: "What you refuse does not vanish. It leaks, at the worst possible moment.", lessonSlug: "jung-shadow-individuation", source: "Carl Jung" },
  { id: "wis-jung-3", text: "The mask is necessary. The mistake is believing it is the whole face.", lessonSlug: "jung-shadow-individuation", source: "Carl Jung" },
  { id: "wis-jung-4", text: "Ambition ends up in the shadow as often as anger. Let one refused quality out this week, on purpose.", lessonSlug: "jung-shadow-individuation", source: "Carl Jung" },
  { id: "wis-rehearse-1", text: "Rehearse the next set from the inside, including the moment it gets hard. Then go lift it.", lessonSlug: "dispenza-rehearsal", source: "Joe Dispenza" },
  { id: "wis-rehearse-2", text: "Every morning you rehearse the same self. Ten minutes a day, rehearse another one.", lessonSlug: "dispenza-rehearsal", source: "Joe Dispenza" },
  { id: "wis-rehearse-3", text: "The brain barely separates a vivid rehearsal from a lived rep. Use that before the bar.", lessonSlug: "dispenza-rehearsal", source: "Joe Dispenza" },
  { id: "wis-rehearse-4", text: "Keep the ten minutes of rehearsal. Leave the physics. Never skip the treatment.", lessonSlug: "dispenza-rehearsal", source: "Joe Dispenza" },
  { id: "wis-huber-1", text: "Ten minutes of morning light sets the clock your whole day, and your sleep, runs on.", lessonSlug: "huberman-protocol-stack", source: "Andrew Huberman" },
  { id: "wis-huber-2", text: "Two inhales, one long exhale. The fastest evidenced way to bring the day back down.", lessonSlug: "huberman-protocol-stack", source: "Andrew Huberman" },
  { id: "wis-huber-3", text: "Protect the dopamine baseline: no phone in the first hour, coffee ninety minutes in.", lessonSlug: "huberman-protocol-stack", source: "Andrew Huberman" },
  { id: "wis-huber-4", text: "Cold before training or on a rest day, never after. The session's adaptation is the point.", lessonSlug: "huberman-protocol-stack", source: "Andrew Huberman" },
  { id: "wis-watts-1", text: "Thrash and you sink. Relax and you float. Reaching for calm is what keeps it away.", lessonSlug: "watts-wisdom-of-insecurity", source: "Alan Watts" },
  { id: "wis-watts-2", text: "Nobody plays a symphony to reach the final chord. Train like the playing is the point.", lessonSlug: "watts-wisdom-of-insecurity", source: "Alan Watts" },
  { id: "wis-watts-3", text: "Try to feel calm and you notice your nerves. Stop reaching and the water holds you.", lessonSlug: "watts-wisdom-of-insecurity", source: "Alan Watts" },
  { id: "wis-watts-4", text: "A session that is only a means to a body burns out. A session that is the thing itself lasts decades.", lessonSlug: "watts-wisdom-of-insecurity", source: "Alan Watts" },
  { id: "wis-rob-1", text: "Success leaves traces. Find someone who has your result and copy the belief, the sequence and the body.", lessonSlug: "robbins-unlimited-power", source: "Tony Robbins" },
  { id: "wis-rob-2", text: "Change the body first. Posture, breath and pace move a mood in seconds; the mind follows.", lessonSlug: "robbins-unlimited-power", source: "Tony Robbins" },
  { id: "wis-rob-3", text: "There are no failures, only results. The result you did not want is information you did not have.", lessonSlug: "robbins-unlimited-power", source: "Tony Robbins" },
  { id: "wis-rob-4", text: "Rapport is matching: pace, posture, the words they use. People trust what feels like them.", lessonSlug: "robbins-unlimited-power", source: "Tony Robbins" },
  { id: "wis-stack-1", text: "The masters, one week, under twenty minutes a day. Believe none of it. Run all of it.", lessonSlug: "wisdom-practice-stack", source: "The Vault" },
  { id: "wis-stack-2", text: "A shelf is finished when it changes a week, not when the last piece is marked complete.", lessonSlug: "wisdom-practice-stack", source: "The Vault" },
  { id: "wis-stack-3", text: "Light, three sighs, one identity sentence. Ten minutes and the day has a spine.", lessonSlug: "wisdom-practice-stack", source: "The Vault" },
  { id: "wis-stack-4", text: "Add the stack in three weeks, not one. The tools for hard moments need a hard moment first.", lessonSlug: "wisdom-practice-stack", source: "The Vault" },
];
