...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    subtitle: "Chicken · basmati · tzatziki",
    blurb: "A Middle Eastern–inspired plate packed with flavour: juicy spice-marinated chicken, fluffy basmati rice, fresh salad, pickled red onion and creamy tzatziki. Balanced and high-protein.",
    tags: ["High protein", "Gluten free"],
    prepMin: 15,
    cookMin: 25,
    nutrition: { calories: 620, protein: 54, carbs: 42, fat: 21 },
    groups: [
      { title: "Chicken shawarma", items: [
        { qty: 180, unit: "g", item: "chicken breast (sliced)" },
        { qty: 0.5, unit: "tsp", item: "garlic powder" },
      ...
      { title: "Basmati rice", items: [
        { qty: 120, unit: "g", item: "cooked basmati rice" },
        { qty: 1, unit: "tsp", item: "fresh parsley (chopped)" },
      ]},
      { title: "Cucumber tomato salad", items: [
        { qty: 0.5, unit: "cup", item: "cucumber (diced)" },
        { qty: 0.5, unit: "cup", item: "cherry tomatoes (halved)" },
        { qty: 1, unit: "tbsp", item: "red onion (finely chopped)" },
        { qty: 1, unit: "tbsp", item: "fresh parsley (chopped)" },
        { item: "juice of 1/4 lemon" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
      { title: "Pickled red onion", items: [
        { qty: 0.25, item: "red onion (thinly sliced)" },
        { qty: 1, unit: "tbsp", item: "red wine vinegar" },
        { item: "pinch of salt" },
      ]},
      { title: "Tzatziki sauce", items: [
        { qty: 75, unit: "g", item: "Greek yogurt (2%)" },
        { qty: 0.25, item: "cucumber (grated & squeezed)" },
        { qty: 1, unit: "clove", item: "garlic (minced)" },
        { qty: 1, unit: "tsp", item: "fresh dill (chopped)" },
        { item: "juice of 1/4 lemon" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
    ],
    method: [
      { title: "Marinate the chicken", steps: [
        "Combine garlic powder, onion powder, cumin, paprika, coriander, turmeric, cinnamon, lemon juice, salt, pepper and olive oil.",
        "Add the sliced chicken and mix well to coat.",
        "Let it marinate for at least 15 minutes.",
      ]},
      { title: "Cook the chicken", steps: [
        "Heat a non-stick skillet over medium-high heat.",
        "Add chicken; cook 6–8 min, turning occasionally, until cooked through and golden.",
        "Remove from heat and sprinkle with fresh parsley.",
      ]},
      { title: "Prepare the rice", steps: [
        "Cook basmati rice according to package instructions.",
        "Fluff with a fork and stir in chopped parsley.",
      ]},
      { title: "Make the salad & pickled onions", steps: [
        "Combine cucumber, tomatoes, red onion, parsley, lemon juice, salt and pepper.",
        "Toss the sliced red onion with red wine vinegar and a pinch of salt. Set aside.",
      ]},
      { title: "Make the tzatziki", steps: [
        "Mix Greek yogurt, grated cucumber, garlic, dill, lemon juice, salt and pepper.",
        "Stir well and refrigerate until ready to serve.",
      ]},
      { title: "Assemble the plate", steps: [
        "Add a scoop of rice to your plate; top with chicken shawarma.",
        "Add cucumber tomato salad, pickled onions and a dollop of tzatziki. Garnish with fresh herbs.",
      ]},
    ],
    mealPrep: {
      fridgeDays: 4,
      reheat: "Microwave chicken + rice 90s; add cold salad, pickled onion & tzatziki after.",
      tips: [
        "Store tzatziki, salad and pickled onion separately so nothing goes soggy.",
        "Batch-cook the chicken and rice; the pickled onion only gets better over a few days.",
        "Squeeze fresh lemon over the salad the day you eat it.",
      ],
    },
  },
  {
    ...
    subtitle: "Lean beef · pasta · parmesan",
    blurb: "A classic Italian favourite: lean ground beef simmered in a rich tomato sauce with herbs and garlic, tossed with pasta and finished with parmesan and fresh basil. Comforting and high-protein.",
    tags: ["High protein", "Gluten option"],
    prepMin: 15,
    cookMin: 25,
    nutrition: { calories: 620, protein: 46, carbs: 54, fat: 21 },
    groups: [
      { title: "Bolognese sauce", items: [
        { qty: 150, unit: "g", item: "lean ground beef (5%)" },
        { qty: 1, unit: "tsp", item: "olive oil" },
        { qty: 0.5, item: "small onion (finely diced)" },
        { qty: 2, unit: "clove", item: "garlic (minced)" },
        { qty: 200, unit: "g", item: "passata (tomato purée)" },
        { qty: 1, unit: "tsp", item: "tomato paste" },
        { qty: 1, unit: "tsp", item: "dried oregano" },
        { qty: 0.5, unit: "tsp", item: "dried basil" },
        { item: "salt & black pepper", note: "to taste" },
        { item: "fresh basil (chopped)" },
      ]},
      { title: "Pasta", items: [
        { qty: 75, unit: "g", item: "whole wheat pasta (dry weight)" },
        { item: "salt for cooking water" },
      ]},
      { title: "Finishing", items: [
        { qty: 10, unit: "g", item: "parmesan cheese (grated)" },
        { item: "fresh basil leaves for garnish" },
      ]},
    ],
    method: [
      { title: "Cook the pasta", steps: [
        "Bring a pot of salted water to a boil.",
        "Add pasta and cook according to package instructions until al dente.",
        "Reserve 1/4 cup of pasta water, then drain and set aside.",
      ]},
      { title: "Brown the beef", steps: [
        "Heat olive oil in a large pan over medium-high heat.",
        "Add ground beef and cook 6–8 min, breaking it up, until browned.",
        "Season with salt and black pepper.",
      ]},
      { title: "Cook the aromatics", steps: [
        "Add diced onion and cook 3–4 min until soft.",
        "Add garlic and cook 30 seconds until fragrant.",
      ]},
      { title: "Simmer the sauce", steps: [
        "Stir in tomato paste and cook for 1 minute.",
        "Add passata, oregano and basil. Stir well.",
        "Reduce heat to low and simmer uncovered 10–15 min, stirring occasionally.",
      ]},
      { title: "Combine", steps: [
        "Add the cooked pasta to the sauce.",
        "Toss together, adding a splash of reserved pasta water if needed to loosen.",
      ]},
      { title: "Finish & serve", steps: [
    ...
    mealPrep: {
      fridgeDays: 4,
      freezerWeeks: 3,
      reheat: "Microwave 2–3 min with a splash of water, or reheat gently in a pan.",
      tips: [
        "The sauce is the meal-prep hero — make a double batch and freeze in portions.",
        "Store sauce and pasta together; a splash of water revives it on reheat.",
  ...
  },
  {
    ...
    prepMin: 5,
    cookMin: 10,
    nutrition: { calories: 320, protein: 23, carbs: 31, fat: 12 },
    groups: [
      { title: "Pancakes", items: [
        { qty: 60, unit: "g", item: "ripe banana", note: "≈ ½ banana" },
        { qty: 1, item: "large egg" },
      ]},
      { title: "Topping", items: [
        { qty: 150, unit: "g", item: "Greek yogurt (0–2% fat)" },
        { qty: 0.5, unit: "cup", item: "mixed berries" },
        { qty: 1, unit: "tsp", item: "honey" },
        { item: "extra berries for garnish" },
      ]},
    ],
    method: [
      { title: "Prepare the batter", steps: [
        "Peel the banana and mash it in a bowl until smooth.",
        "Add the egg and whisk until fully combined — the batter should be smooth and slightly thick.",
      ]},
      { title: "Cook the pancakes", steps: [
        "Heat a non-stick pan over medium heat and lightly grease with a little oil.",
        "Pour small rounds of batter into the pan.",
        "Cook 2–3 min until bubbles form and the edges look set.",
        "Flip and cook another 1–2 min until golden and cooked through.",
      ]},
      { title: "Prepare the topping", steps: [
        "Add Greek yogurt on top of the pancakes.",
        "Add mixed berries and extra berries for garnish; drizzle with honey.",
      ]},
      { title: "Serve & enjoy", steps: [
        "Serve immediately and enjoy your high-protein, naturally sweet pancakes.",
      ]},
    ],
    mealPrep: {
      fridgeDays: 2,
      reheat: "Reheat plain pancakes in a dry pan or toaster; add yogurt & berries fresh.",
      tips: [
        "Batter is best made fresh — cook the pancakes ahead and store them plain.",
        "Keep yogurt, berries and honey separate; assemble the morning you eat.",
        "Double the batter (1 banana + 2 eggs) for two servings.",
      ],
    },
  },
  {
    ...
    prepMin: 5,
    cookMin: 0,
    nutrition: { calories: 360, protein: 27, carbs: 45, fat: 7 },
    groups: [
      { title: "Greek yogurt", items: [
        { qty: 250, unit: "g", item: "Greek yogurt (0–2% fat)" },
      ]},
      { title: "Apple mix", items: [
        { qty: 1, item: "medium apple (~150 g)" },
        { qty: 1, unit: "tsp", item: "cinnamon" },
        { qty: 1, unit: "tsp", item: "honey" },
      ]},
      { title: "Topping", items: [
        { qty: 20, unit: "g", item: "granola" },
      ]},
    ],
    method: [
      { title: "Prepare the apples", steps: [
        "Dice the apple into small cubes.",
        "In a bowl, mix apple with cinnamon and honey.",
        "Let it sit for a few minutes to release flavour and soften slightly.",
      ]},
      { title: "Assemble the bowl", steps: [
        "Add Greek yogurt to a bowl and smooth it out.",
        "Top with the cinnamon apple mix.",
      ]},
      { title: "Add the finishing touch", steps: [
        "Sprinkle granola on top for a little crunch.",
    ...
    mealPrep: {
      ...
      tips: [
        "Prep the cinnamon apple mix in jars for the week; it keeps 3 days.",
        "Add granola only when serving so it stays crisp.",
        "Microwave the apple 30s first if you prefer it warm and soft.",
      ],
    },
  },
  {
    id: "sweet-potato-black-bean-taco-bowl",
    title: "Sweet Potato & Black Bean Taco Bowl",
    subtitle: "Sweet potato · black beans · avocado",
    blurb: "A vibrant, plant-powered bowl packed with bold flavours, fibre and nourishing ingredients — roasted sweet potato, spiced black beans, grains and a creamy avocado lime sauce.",
    tags: ["Vegan", "High fibre"],
    prepMin: 15,
    cookMin: 25,
    nutrition: { calories: 520, protein: 18, carbs: 75, fat: 17 },
    groups: [
      { title: "Sweet potato", items: [
        { qty: 200, unit: "g", item: "sweet potato (peeled & cubed)" },
        { qty: 1, unit: "tsp", item: "olive oil" },
        { qty: 0.5, unit: "tsp", item: "smoked paprika" },
        { qty: 0.5, unit: "tsp", item: "garlic powder" },
        { item: "salt & black pepper", note: "to taste" },
      ...
      { title: "Black beans", items: [
        { qty: 150, unit: "g", item: "black beans (cooked & rinsed)" },
        { qty: 0.5, unit: "tsp", item: "cumin" },
        { qty: 0.5, unit: "tsp", item: "chili powder" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
      { title: "Bowl toppings", items: [
        { qty: 50, unit: "g", item: "cooked brown rice or quinoa" },
        { qty: 0.25, unit: "cup", item: "corn kernels" },
        { qty: 0.25, unit: "cup", item: "diced tomato (pico de gallo)" },
        { qty: 0.25, item: "avocado (sliced)" },
        { qty: 0.25, item: "red onion (finely diced)" },
        { item: "fresh cilantro" },
        { item: "lime wedge" },
      ]},
      { title: "Avocado lime sauce", items: [
        { qty: 0.5, item: "avocado (~70 g)" },
        { item: "juice of 1/2 lime" },
        { item: "handful of fresh cilantro" },
        { qty: 1, unit: "clove", item: "garlic (small)" },
        { qty: 2, unit: "tbsp", item: "water", note: "adjust for texture" },
        { item: "pinch of salt" },
      ]},
    ],
    method: [
      { title: "Roast the sweet potato", steps: [
        ...
        "Spread on a baking sheet and roast 20–25 min until tender and slightly crispy.",
      ]},
      { title: "Make the avocado lime sauce", steps: [
        "Add all sauce ingredients to a blender.",
        "Blend until smooth and creamy; add water as needed for desired consistency.",
        "Taste and adjust salt.",
      ]},
      { title: "Cook the black beans", steps: [
        "In a small pan, warm the black beans.",
        "Add cumin, chili powder, salt and pepper.",
        "Cook 3–4 min, stirring occasionally.",
      ]},
      { title: "Assemble the bowl", steps: [
        "Add rice or quinoa to the base of a bowl.",
        "Top with roasted sweet potato, black beans, corn, pico de gallo, avocado and red onion.",
        "Drizzle with avocado lime sauce and garnish with fresh cilantro.",
      ]},
      { title: "Finish & enjoy", steps: [
        "Squeeze fresh lime over the top and enjoy your vibrant taco bowl.",
      ]},
    ],
    mealPrep: {
      fridgeDays: 4,
      reheat: "Reheat sweet potato, beans & grain 2 min; add avocado, sauce & fresh toppings after.",
      tips: [
        "Batch-roast the sweet potato and spice the beans ahead — they keep all week.",
        "Avocado lime sauce browns; make it fresh or press cling film onto the surface.",
        "Keep avocado, pico and cilantro fresh; assemble the day you eat.",
      ],
    },
  },
  {
    id: "sirloin-steak-chimichurri",
    title: "Sirloin Steak with Rosemary Oven Potatoes & Chimichurri",
    subtitle: "Sirloin · rosemary potatoes · chimichurri",
    blurb: "A restaurant-quality steak dinner made with real ingredients: juicy sirloin, crispy rosemary potatoes and fresh homemade chimichurri — the perfect balance of flavour, protein and nutrition.",
    tags: ["High protein", "Gluten free"],
    prepMin: 10,
    cookMin: 30,
    nutrition: { calories: 830, protein: 52, carbs: 42, fat: 46 },
    groups: [
      { title: "Sirloin steak", items: [
        { qty: 200, unit: "g", item: "sirloin steak" },
        { qty: 5, unit: "g", item: "unsalted butter" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
      { title: "Rosemary potatoes", items: [
        { qty: 250, unit: "g", item: "baby potatoes" },
        { qty: 1, unit: "tsp", item: "olive oil" },
        { qty: 1, unit: "tsp", item: "fresh rosemary (finely chopped)" },
        { qty: 1, unit: "tsp", item: "garlic powder" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
      { title: "Chimichurri", items: [
        { qty: 15, unit: "g", item: "fresh parsley (finely chopped)" },
        { qty: 1, unit: "clove", item: "garlic (finely chopped)" },
        { qty: 1, unit: "tbsp", item: "red wine vinegar" },
        { qty: 1, unit: "tbsp", item: "olive oil" },
        { qty: 0.5, unit: "tsp", item: "chili flakes", note: "optional" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
    ],
    method: [
      { title: "Roast the rosemary potatoes", steps: [
        "Preheat oven to 200°C (400°F).",
        "Halve the baby potatoes.",
        "Toss with olive oil, rosemary, garlic powder, salt and pepper.",
        "Roast 25–30 minutes, until golden and crispy.",
      ]},
      { title: "Make the chimichurri", steps: [
        "Finely chop the parsley and garlic.",
        "Add parsley, garlic, red wine vinegar, chili flakes, salt and pepper to a bowl.",
        "Slowly add olive oil and stir until well combined. Set aside.",
      ]},
      { title: "Cook the sirloin steak", steps: [
        "Pat the steak dry and season generously with salt and black pepper.",
        "Heat a skillet over high heat.",
        "Cook 2–3 minutes per side for medium-rare.",
        "Add butter during the final 30 seconds and baste the steak. Rest 5 minutes.",
      ]},
      { title: "Assemble & enjoy", steps: [
        "Slice the steak against the grain.",
        "Serve with rosemary potatoes and spoon chimichurri generously over the steak.",
      ]},
    ],
    mealPrep: {
      fridgeDays: 3,
      reheat: "Reheat potatoes; warm steak gently (~60s — don't overcook). Add chimichurri fresh.",
      tips: [
        "Chimichurri keeps 4–5 days in a jar and only gets better — make a big batch.",
        "Slice steak just before eating to keep it juicy; store it whole if you can.",
        "Batch-roast the potatoes; they reheat crisp in an air fryer or hot oven.",
      ],
    },
  },
  {
    id: "halloumi-power-plate",
    title: "Halloumi Power Plate",
    subtitle: "Halloumi · rosemary potatoes · tzatziki",
    blurb: "A Mediterranean-inspired plate: golden halloumi, crispy rosemary potatoes, fresh tzatziki, juicy tomatoes, olives and feta. Balanced, vegetarian and satisfying.",
    tags: ["High protein", "Gluten free"],
    prepMin: 15,
    cookMin: 35,
    nutrition: { calories: 790, protein: 38, carbs: 34, fat: 56 },
    groups: [
      { title: "Halloumi", items: [
        { qty: 150, unit: "g", item: "halloumi cheese" },
        { item: "fresh black pepper", note: "to taste" },
      ]},
      { title: "Roasted rosemary potatoes", items: [
        { qty: 180, unit: "g", item: "baby potatoes (halved)" },
        { qty: 1, unit: "tsp", item: "olive oil" },
        { qty: 1, unit: "tsp", item: "fresh rosemary (chopped)" },
        { qty: 0.5, unit: "tsp", item: "garlic powder" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
      { title: "Tzatziki", items: [
        { qty: 100, unit: "g", item: "Greek yogurt (2%)" },
        { qty: 0.5, item: "cucumber (grated & squeezed)" },
        { qty: 1, unit: "clove", item: "garlic (minced)" },
        { qty: 0.5, unit: "tsp", item: "lemon juice" },
        { item: "fresh dill (chopped)" },
        { item: "salt", note: "to taste" },
      ]},
      { title: "Extras", items: [
        { qty: 60, unit: "g", item: "cherry tomatoes (halved)" },
        { qty: 30, unit: "g", item: "Kalamata olives" },
        { qty: 30, unit: "g", item: "feta cheese (crumbled)" },
    ...
    method: [
      { title: "Roast the potatoes", steps: [
        ...
        "Spread on a baking sheet and roast 30–35 min, flipping halfway, until golden and crispy.",
      ]},
      { title: "Make the tzatziki", steps: [
        "Combine Greek yogurt, cucumber, garlic, lemon juice and salt.",
        "Mix well and stir in fresh dill.",
        "Refrigerate until ready to serve.",
      ]},
      { title: "Cook the halloumi", steps: [
        "Heat a non-stick skillet over medium-high heat.",
        "Add halloumi slices and cook 2–3 min per side until golden and crispy.",
        "Season with fresh black pepper.",
      ]},
      { title: "Assemble the plate", steps: [
        "Arrange roasted potatoes and halloumi on a plate.",
        "Add cherry tomatoes, olives and crumbled feta; spoon tzatziki on the side.",
        "Garnish with fresh parsley and enjoy.",
      ]},
    ],
    mealPrep: {
      fridgeDays: 3,
      reheat: "Reheat potatoes; pan-crisp halloumi fresh (it goes rubbery cold). Add cold extras + tzatziki after.",
      tips: [
        "Halloumi is best cooked fresh — store it uncooked and sear when you eat.",
        "Batch-roast potatoes and pre-make tzatziki (keeps 3 days).",
        "Keep tomatoes, olives and feta separate so the plate stays fresh.",
      ],
    },
  },
  {
    id: "burger-bowl",
    title: "Burger Bowl",
    subtitle: "Beef · roasted potatoes · burger sauce",
    blurb: "All the burger flavours you love, reimagined in a balanced, high-protein bowl: savoury seasoned ground beef, crispy roasted potatoes and fresh veggies topped with a creamy burger sauce.",
    tags: ["High protein", "Gluten free"],
    prepMin: 15,
    cookMin: 30,
    nutrition: { calories: 790, protein: 48, carbs: 42, fat: 45 },
    groups: [
      { title: "Seasoned ground beef", items: [
        { qty: 300, unit: "g", item: "lean ground beef (5% fat)" },
        { qty: 0.5, unit: "tsp", item: "garlic powder" },
        { qty: 0.5, unit: "tsp", item: "onion powder" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
      { title: "Roasted potatoes", items: [
        { qty: 200, unit: "g", item: "baby potatoes (cubed)" },
        { qty: 1, unit: "tsp", item: "olive oil" },
        { qty: 0.5, unit: "tsp", item: "paprika" },
        { qty: 0.5, unit: "tsp", item: "garlic powder" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
      { title: "Fresh toppings", items: [
        { qty: 1, unit: "cup", item: "shredded lettuce" },
        { qty: 0.5, item: "tomato (diced)" },
        { qty: 0.25, item: "small red onion (thinly sliced)" },
        { qty: 1, unit: "tbsp", item: "pickles (sliced)" },
      ]},
      { title: "Burger sauce", items: [
        { qty: 2, unit: "tbsp", item: "plain Greek yogurt" },
        { qty: 1, unit: "tsp", item: "ketchup" },
        { qty: 1, unit: "tsp", item: "mustard" },
        { qty: 0.5, unit: "tsp", item: "pickle juice" },
        { qty: 0.5, unit: "tsp", item: "garlic powder" },
        { item: "salt & black pepper", note: "to taste" },
      ]},
    ],
    method: [
      { title: "Roast the potatoes", steps: [
        ...
        "Spread on a baking sheet and roast 25–30 min until golden and crispy, flipping halfway.",
      ]},
      { title: "Make the burger sauce", steps: [
        "In a small bowl, combine Greek yogurt, ketchup, mustard, pickle juice, garlic powder, salt and pepper.",
        "Mix well and set aside.",
      ]},
      { title: "Cook the ground beef", steps: [
        "Season ground beef with garlic powder, onion powder, salt and black pepper.",
        "Heat a non-stick skillet over medium-high heat.",
        "Cook the beef, breaking it up, 6–8 min until fully cooked and browned. Drain excess fat if needed.",
      ]},
      { title: "Assemble & enjoy", steps: [
        "Add the cooked ground beef to your bowl.",
        "Add roasted potatoes, lettuce, tomato, red onion and pickles.",
        "Drizzle generously with burger sauce and dig in.",
      ]},
    ],
    mealPrep: {
      fridgeDays: 4,
      reheat: "Reheat beef + potatoes 2 min; add lettuce, tomato, onion, pickles & sauce after.",
      tips: [
