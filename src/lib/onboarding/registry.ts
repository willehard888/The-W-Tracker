...
export const ONBOARDING_EVENTS: Record<OnboardingEventId, OnboardingEventDef> = {
  ...
  XP_INTRO: {
    ...
    presentation: "spotlight",
    title: "That's XP",
    body: "Your day scores 0 to 100 — 150 with Apple Health. Training, sleep, water, mind, your habits: each a line.",
    cta: "Nice",
    fallback: "skip",
    backdropDismiss: true,
  },
  ...
  PROGRESSION_INTRO: {
    ...
    presentation: "spotlight",
    title: "Level up",
    body: "Your rating is your last 28 days. It climbs the tiers — Recruit to Legend.",
    cta: "Got it",
    fallback: "skip",
    backdropDismiss: true,
  },
