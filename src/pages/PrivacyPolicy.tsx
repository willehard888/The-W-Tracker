  ...
  return (
    <div className="min-h-full">
      ...
      <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
        ...
        <section>
          <h2 className="font-display font-black text-lead tracking-tight leading-tight text-foreground mb-2">5. Apple Health (HealthKit)</h2>
        ...
        <section>
          <h2 className="font-display font-black text-lead tracking-tight leading-tight text-foreground mb-2">6. Subscriptions & Payments</h2>
        ...
        <section>
          <h2 className="font-display font-black text-lead tracking-tight leading-tight text-foreground mb-2">7. Your Rights</h2>
        ...
        <section>
          <h2 className="font-display font-black text-lead tracking-tight leading-tight text-foreground mb-2">8. Children's Privacy</h2>
        ...
        <section>
          <h2 className="font-display font-black text-lead tracking-tight leading-tight text-foreground mb-2">9. Contact Us</h2>
