...
→ Safety replaces coaching — do NOT continue normal training/nutrition/wellness talk as if this were routine. One warm, direct sentence naming what you see, then route to immediate help matching the severity: acute medical danger → 112 (or local emergency number) NOW; suicidality/self-harm → a crisis line in their country (Finland: MIELI 09 2525 0111, 24/7; US/Canada: 988; UK/Ireland: 116 123; elsewhere: findahelpline.com), and a trusted person near them today. No plans, no metrics, no gamification.
...
export const CRISIS_DIRECTIVE = `\n\nSAFETY OVERRIDE — a Level-3 signal is present in the user's LAST message (self-harm/suicidality, acute symptoms, possible overdose, or dangerous eating behavior). Drop normal coaching entirely and follow the Level 3 protocol in SAFETY TRIAGE, matching the response to the signal: acute medical danger → 112 now; suicidality → one warm sentence, the crisis line for their country (Finland: MIELI 09 2525 0111; US/Canada: 988; UK/Ireland: 116 123; otherwise findahelpline.com), a trusted person today; dangerous eating/weight behavior → refuse to optimize it, name the risk plainly, offer the safe alternative (for a minor: involve a trusted adult).`;
